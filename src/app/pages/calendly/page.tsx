		...
		<main>
			<section className="pt-8 pb-[80px]">
				<div className="max-w-[1200px] mx-auto px-4">
					...
					>
						<span className="text-[#005e05]">Último paso!</span> Elegí una fecha y hora que te queden cómodas y empezá hoy mismo!
					</h1>
			...
			<section className="px-4">
				<div className="max-w-[1200px] mx-auto px-4 border-t border-b border-[#005e05] py-[40px]">
			...
			<section className="py-[40px] px-4">
				<div className="max-w-[1200px] mx-auto">
					<div className="grid md:grid-cols-3 gap-4 mt-8">
						<div>
							<p className="text-center py-2 bg-[#005e05] text-black font-semibold">
								{/* Mateo Falco */}
								-17 KG en 3 Meses
							</p>
