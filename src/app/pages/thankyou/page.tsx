    ...
    <div className="bg-white">
      <div className="max-w-[700px] mx-auto px-4 py-[60px] bg-white">
        ...
        <p className="text-[20px] text-black">
          ...
          <br /><br />
          (Ya te debería haber llegado, si no es el caso, escribime acá <a className="text-blue-400 underline" target="_blank" href="https://wa.me/+XXXXXX">+XXXXXX</a>)
          <br /><br />
          <strong>💡 Tip:</strong>
          <br />
          ...
          Este es mi WhatsApp:
          <br />
          <a className="text-blue-400 underline" target="_blank" href="https://wa.me/+XXXXXX">+XXXXXX</a>
        </p>
